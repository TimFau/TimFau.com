...
$portfolioItems = array(
    ...
    3 => array(
        ...
        "description" => "Rockin’ with Purpose is a music blog geared towards promoting Christian Rock and Roll with purpose. They were  looking for a hip new image for the site, taking it from a simple free-template blog to a scalable, hip web magazine. I designed a from-scratch WordPress template featuring most prominently a featured & recent content section, as well as spots for album and artist spotlights. It’s built to be responsive and allow for easy viewing of and by categories.",
        "categories" => array(
            "design", "frontend"
        ),
        "skills" => array (
        ...
        "websiteURL" => "http://rockinwithpurpose.com/",
        "sourceURL" => "",
        "featured" => true
    ),
    4 => array(
